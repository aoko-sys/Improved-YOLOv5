...
img_h, img_w, stride_h, stride_w = 640, 640, 448, 448
...
for idx, img in enumerate(images):
    ...
    '''
    file_idx, image, boxes_all, width, height, stride_w, stride_h=img.strip('.jpg'), img_data, box, img_w, img_h, stride_w, stride_h
